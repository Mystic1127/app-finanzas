...
private val SpendlyDarkColors: ColorScheme = darkColorScheme(
    primary = Color(0xFF3F7A53),
    onPrimary = Color(0xFFF4FFF9),
    primaryContainer = Color(0xFF00342B),
    onPrimaryContainer = Color(0xFFA7EBCB),
    secondary = Color(0xFF82B6A3),
    onSecondary = Color(0xFF071812),
    secondaryContainer = Color(0xFF071C18),
    onSecondaryContainer = Color(0xFFD2E9DE),
    ...
    surfaceVariant = Color(0xFF0B1624),
    onSurfaceVariant = Color(0xFFACB8C7),
    outline = Color(0xFF3B5068),
    outlineVariant = Color(0xFF1A2A3D),
